...
function nextGeneration() {
  ...
  for (let triplet of queue) {
    ...
    let newCircles = complexDescartes(c1, c2, c3, k4, depth);
...
function complexDescartes(c1, c2, c3, k4, depth) {
  ...
  return [
    new Circle(k4[0], center1.a, center1.b, depth),
    new Circle(k4[0], center2.a, center2.b, depth),
    new Circle(k4[1], center3.a, center3.b, depth),
    new Circle(k4[1], center4.a, center4.b, depth),
  ];
}
...
function mousePressed() {
  // Start with the newer circles
  for (let i = allCircles.length - 1; i >= 0; i--) {
    // If circle was surprised break out of the loop
    if (allCircles[i].mousePressed()) {
      break;
    }
  }
}
